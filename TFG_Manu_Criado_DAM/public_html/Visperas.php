...
if (!isset($_SESSION["Login"])) {
    ...
    <body>
        ...
        <div class="container">
            ...
            encabezado();
            ?>
            <form method="post" action="Visperas.php">
            ...
            if (empty($_SET)) {
                ...
                echo"<h1>Visperas del día: " . $Nfecha . "</h1> ";
                $sql = "select * from visperas where fecha =\"$Nfecha\"";
                ...
                while ($mostrar = mysqli_fetch_array($result)) {
                    ...
                    echo '</div>';
                    echo "<div class=\"hijo\">";
                    $frases5 = explode($separador, $mostrar['cantico_at']);
                    $tamaño5 = sizeof($frases5);
                    echo '<center><h3><b>Cántico AT </b></h3></center>';
                    echo "<div class=\"hijo2\">";
                    for ($i = 1; $i < $tamaño5; $i++) {
                    ...
                    echo "<div class=\"hijo\">";
                    $frases8 = explode($separador, $mostrar['preces']);
                    $tamaño8 = sizeof($frases8);
                    echo '<center>';
                    echo '<h3><b>Preces</b></h3>';
                    echo '</center>';
                    echo "<div class=\"hijo2\">";
                    for ($i = 0; $i < $tamaño8; $i++) {
                    ...
                    echo '</div>';
                    echo '<br>Llenos del Espirítu de Jesucristo, acudamos a nuestro Padre común, diciendo:<br>
                    <b>Padre nuestro</b> que estas en el cielo, santificado sea tu nombre;<br>venga a nosotros tu reino;<br>hágase tu voluntuda en la tierra como en el cielo.<br>Danos hoy nuestro pan de cada día;<br>perdona nuestras ofensas como tambien nostros perdonamos a los que nos ofenden.<br>No nos dejes caer en la tentación, ylíbranos del mal.';
                    ...
                    echo '<br>';
                     echo '<div class="hijo"
                        ...
                        Oremos:<br>
                        Nuestra oración vespertina suba hasta ti, Padre de clemencia, y descienda sobre nosotros tu bendición; así, con tu ayuda, seremos salvados ahora y por siempre. Por nuestro Señor Jesucristo, tu Hijo, que vive y reina contigo en la unidad del Espíritu Santo y es Dios por los siglos de los siglos.<br>
                        <center>
                        Amén<br>                     
                        </div>
                    </div>';
