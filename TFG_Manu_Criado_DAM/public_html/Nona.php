...
if (!isset($_SESSION["Login"])) {
    ...
    <body>
        ...
        <div class="container">
            ...
            encabezado();
            ?>
            <form method="post" action="Nona.php">
            ...
            if (empty($_SET)) {
                ...
                echo"<h1>Nona del día: " . $Nfecha . "</h1> ";
                $sql = "select * from nona where fecha =\"$Nfecha\"";
                ...
                while ($mostrar = mysqli_fetch_array($result)) {
                   ...
                   echo '<div class="hijo">
                        ...
                        Oremos:<br>
                        Dios todopoderoso, concedenos en nuestra vida y en nuestras costrumbres la alegría de estas fiestas de Pascua que nos disponemos a clausurar. Por Jesucristo nuestro Señor.<br>
                        <center>
                        Amén<br>
                        </div>
                    </div>';
